...
ALTER TABLE "client_profile_zips" ADD CONSTRAINT "client_profile_zips_city_zip_city_fk" FOREIGN KEY ("city_zip_id","city_id") REFERENCES "public"."city_zips"("id","city_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_entitlements" ADD CONSTRAINT "user_entitlements_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "agent_profiles_city_id_index" ON "agent_profiles" USING btree ("city_id");--> statement-breakpoint
