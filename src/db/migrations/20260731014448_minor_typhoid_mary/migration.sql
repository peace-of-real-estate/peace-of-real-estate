...
ALTER TABLE "intro_unlock_fulfillments" ADD CONSTRAINT "intro_unlock_fulfillments_client_profile_id_fk" FOREIGN KEY ("client_profile_id") REFERENCES "client_profiles"("id") ON DELETE CASCADE;--> statement-breakpoint
