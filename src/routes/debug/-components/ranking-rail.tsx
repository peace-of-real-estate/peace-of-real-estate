...
import { EmptyState } from '@/routes/debug/-components/query-states'
import {
	groupByBand,
	isBandView,
	type RankingFilters,
...
import { RankingToolbar } from '@/routes/debug/-components/ranking-toolbar'
import { TieBandGroup } from '@/routes/debug/-components/tie-band-group'
...
export function RankingRail({
	...
	const [dqOpen, setDqOpen] = React.useState(false)
	...
	if (matches.totalAgents === 0) {
		return (
			<EmptyState
				...
				hint="Run `pnpm db:seed` to populate agents."
			/>
		)
	}
