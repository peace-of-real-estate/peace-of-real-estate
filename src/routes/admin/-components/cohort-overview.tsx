...
} from '@/routes/admin/-components/cohort-geo-map'
import { DimensionCohortStats } from '@/routes/admin/-components/dimension-cohort-stats'
import { GateKillCounts } from '@/routes/admin/-components/gate-kill-counts'
import { MapPlaceholder } from '@/routes/admin/-components/map-support'
import { ScoreHistogram } from '@/routes/admin/-components/score-histogram'
import { SectionLabel } from '@/routes/admin/-components/section-label'
import { WeightsPanel } from '@/routes/admin/-components/weights-panel'
			...
			<div className="grid gap-3 xl:grid-cols-2">
				{showMap &&
					(mapsEnabled ? (
						<CohortGeoMap
							client={clientCenter}
							clientLabel={`${matches.clientProfile.city.name}, ${matches.clientProfile.city.state}`}
							agents={agentPoints}
