...
import { CompareDimensionTable } from '@/routes/admin/-components/compare-dimension-table'
import { DeltaValue } from '@/routes/admin/-components/delta-value'
	...
	return (
		<span
			className={cn(
				...
				passFailTextClass(!disqualified),
			)}
		>
			<PassFailIcon pass={!disqualified} className="size-3" />
			{disqualified ? 'failed' : 'passed'}
		</span>
	)
}
